...
class Tickets extends MY_Controller {
    ...
    function index() {
        ...
        if ($this->login_user->user_type === "staff") {
            ...
            $view_data['show_options_column'] = $this->can_delete_tickets(); //since there is only one button in options column
    ...
    private function _make_row($data, $custom_fields) {
        ...
        if ($this->can_delete_tickets()) {
            $options = js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("tickets/delete"), "data-action" => "delete-confirmation"));
        }

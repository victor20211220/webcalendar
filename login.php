...
<link rel="stylesheet" type="text/css" href="01style.css">
...
<h5></h5>
<h6>MBS</h6>
<span>Manor Booking System</span>
</div>


 <img src="images/login.gif" alt="Login" /></td><td align="right">
 <label for="user"><?php etranslate ( 'Username' )?>:</label></td><td>
 <input placeholder="Nazwa uzytkownika" name="login" id="user" size="15" maxlength="25"
...
<tr><td class="alignright">
 ...
 <input placeholder="Haslo" name="password" id="password" type="password" size="15"
